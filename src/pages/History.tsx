  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#e7f0fa]">Upload History</h1>
        ...
        <div className="space-y-4">
          {filteredHistory.length === 0 ? (
            <div className="text-center py-12">
              <FileText className="mx-auto text-[#e7f0fa]/30 mb-4" size={48} />
              <p className="text-[#e7f0fa]/60">No files found matching your filters</p>
            </div>
          ) : (
            filteredHistory.map((item) => (
              <div
                key={item.id}
                className="bg-[#0c111a] border border-[#14e7ff]/10 rounded-lg p-6 hover:border-[#14e7ff] transition-all duration-300 cursor-pointer"
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-semibold text-[#e7f0fa] mb-1 truncate">
                        {item.fileName}
                      </h3>
      ...
      {filteredHistory.length > 0 && (
        <div className="flex justify-center">
          <div className="flex items-center gap-2">
            <button className="px-4 py-2 bg-[#151c27] text-[#e7f0fa] border border-[#14e7ff]/20 rounded-lg hover:border-[#14e7ff] transition-colors disabled:opacity-50">
              Previous
            </button>
            <span className="text-[#e7f0fa]/60">Page 1 of 1</span>
            <button className="px-4 py-2 bg-[#151c27] text-[#e7f0fa] border border-[#14e7ff]/20 rounded-lg hover:border-[#14e7ff] transition-colors disabled:opacity-50">
              Next
            </button>
          </div>
