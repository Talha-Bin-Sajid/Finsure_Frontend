...
//         <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg p-6 hover:border-[#14e7ff] transition-all duration-300">
//           <div className="w-12 h-12 bg-[#14e7ff]/10 rounded-lg flex items-center justify-center mb-4">
//             <Book className="text-[#14e7ff]" size={24} />
//           </div>
//           <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Documentation</h3>
...
//           </div>
//           <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Live Chat</h3>
//           <p className="text-[var(--text-primary)] opacity-70 mb-4">
...
//             <Book className="text-[#14e7ff]" size={24} />
//           </div>
//           <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">FAQs</h3>
//           <p className="text-[var(--text-primary)] opacity-70 mb-4">
